	...
	<div class="max-w-4xl mx-auto mt-8">
		<form action="{{ route('photos.update', $photo->id) }}" method="POST" enctype="multipart/form-data"
			...
			<div>
				...
				<input type="text" name="title" id="title" placeholder="Photo title" value="{{ $photo->title }}"
			...
			<!-- Input Photo -->
            <img src="/storage/albums/{{ $photo->album_id }}/{{ $photo->photo }}" alt="photo" class="max-w-sm rounded-2xl">
			<div>
