	...
	<div class="max-w-4xl mx-auto mt-8">
		<form action="{{ route('albums.update', $album->id) }}" method="POST" enctype="multipart/form-data"
			...
			<div>
				...
				<input type="text" name="name" id="name" placeholder="Album name" value="{{ $album->name }}"
			...
			<div>
				...
				<input type="text" name="description" id="description" placeholder=" Album description" value="{{ $album->description }}"
					class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
			</div>
